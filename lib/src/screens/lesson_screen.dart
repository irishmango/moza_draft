...
import 'package:moza_draft/src/widgets/lesson_main_card.dart';
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                        SizedBox(width: 8,),
                        TopicCard(title: "Plagal Cadences", color: AppColors.appRed, path: () => ComingSoon(),),
                        SizedBox(width: 8,),
                        TopicCard(title: "Perfect Cadences", color: AppColors.appRed, path: () => ComingSoon(),),
                         SizedBox(width: 8,),
                        TopicCard(title: "Imperfect Cadences", color: AppColors.appRed, path: () => ComingSoon(),),                         
                      ],
                    ),
                  ),
                  SizedBox(height: 8,),
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        HeaderExpand(title: "Extra Lessons", path: () => LessonScreen(),),
                      ],
                    ),
                  )
